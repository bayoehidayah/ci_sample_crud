...
<html lang="en">
	...
	<head>
		...
		<link href="<?php echo base_url();?>assets/app/custom/login/login-v2.default.css" rel="stylesheet" type="text/css" />
					...
					<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
						<div class="kt-login__container">
							<div class="kt-login__logo">
								<a href="#">
									<img src="<?php echo base_url();?>assets/media/logos/logo-mini-2-md.png">
								</a>
							</div>
